...
public class HomePage {
    ...
    private final By LOKATOR_REKLAMA = By.xpath(".//*[contains(@style, 'display:block')]");
    private final By TITLE = By.xpath("//*[contains(@class, 'list-article__headline')]");
    private final By COMMENTS = By.xpath(".//*[contains(@class, 'list-article__comment')]");
    private final By ARTICLE = By.xpath(".//*[contains(@itemprop, 'headline name')]");

    private final Logger LOGGER = LogManager.getLogger(this.getClass());
    private pageobject.pages.BaseFunc baseFunc;
    public HomePage(pageobject.pages.BaseFunc baseFunc) {
        this.baseFunc = baseFunc;
    }
    public void acceptCookies() {
        LOGGER.info("Accepting cookies");
        baseFunc.click(ACCEPT_COOKIES_BTN);
        baseFunc.click(LOKATOR_REKLAMA);
    }
...
//git
    ...
    public int getCommentsCount(int id) {
        LOGGER.info("Getting comments count for article Nr. : 1");
